# Estimating Urban Rail Construction Costs Using Machine Learning
...
The accuracy achieved by the model with a mean absolute error of 543.95M USD and an R-squared of .896 is sufficient for the purposes of creating a user focused model that can estimate the potential cost for a project in a given area. This model is deployed and [available for anyone to use at](https://buildmoretrains.streamlit.app/) 
